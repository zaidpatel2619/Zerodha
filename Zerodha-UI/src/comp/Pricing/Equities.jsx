        ...
        <div className="col-10 table-responsive border p-0">
          <table className="table table-borderless charges-table">
            <thead className="border-bottom">
              <tr>
                <th> </th>
                <th className='text'>Equity delivery</th>
                <th className='text'>Equity intraday</th>
                <th className='text'>F&O - Futures</th>
                <th className='text'>F&O - Options</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className='text'>Brokerage</td>
                <td className='text'>Zero Brokerage</td>
                <td className='text'>0.03% or Rs. 20/executed order whichever is lower</td>
                <td className='text'>0.03% or Rs. 20/executed order whichever is lower</td>
                <td className='text'>Flat Rs. 20 per executed order</td>
              </tr>
              <tr>
                <td className='text'>STT/CTT</td>
                <td className='text'>0.1% on buy & sell</td>
                <td className='text'>0.025% on the sell side</td>
                <td className='text'>0.02% on the sell side</td>
                <td className='text'>
                  <ul>
              ...
              <tr>
                ...
                <td className='text'>NSE: 0.00297%<br />BSE: 0.00375%</td>
                <td className='text'>NSE: 0.00297%<br />BSE: 0.00375%</td>
                <td className='text'>NSE: 0.00173%<br />BSE: 0</td>
                <td className='text'>NSE: 0.03503% (on premium)<br />BSE: 0.0325% (on premium)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className='text'>0.015% or ₹1500 / crore on buy side</td>
